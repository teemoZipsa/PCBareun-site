...
| 대시보드 | 임시 파일 정리 |
|:---:|:---:|
| ![대시보드](dashboard.png) | ![임시 파일 정리](temp_cleaner.png) |

| 레지스트리 정리 | AI & 개발 환경 정리 |
|:---:|:---:|
| ![레지스트리 정리](registry_cleaner.png) | ![AI 정리](ai_optimizer.png) |

---

## 주요 특징

- **정리** — 임시 파일, 레지스트리, 중복 파일, 유사 이미지 정리
- **진단** — S.M.A.R.T. 디스크 상태, 폴더 용량, BSOD, 네트워크 점검
- **앱 관리** — 시작 프로그램, 서비스, 작업 스케줄러, 설치 프로그램 확인
- **보안 점검** — DNS/hosts 이상 징후 확인, API 키 노출 후보 탐지, 사용 흔적 정리
